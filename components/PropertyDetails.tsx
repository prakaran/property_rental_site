  ...
  return (
    <main>
      <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
        ...
        <h1 className="text-3xl font-bold mb-4 dark:text-black">
          {property.name}
        </h1>
        <div className="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
          <FaMapMarker className="text-lg text-orange-700 mr-2" />
          <p className="text-orange-700">
            {Object.values(property.location).join(" ")}
          </p>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        <h3 className="text-lg font-bold mb-6 dark:text-black">
          Description & Details
        </h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        <h3 className="text-lg font-bold mb-6 dark:text-black">Amenities</h3>
